...
// Program dla n przyjmuje wartosc aktualnego indexu czyli n=i;
// Zlicza za pomoca f wirtualnych sume wyrazow ciagu arytmetycznego i geometrycznego (oddzielnie dla kazdego ciagu)
